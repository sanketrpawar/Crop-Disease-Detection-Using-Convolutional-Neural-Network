...
public class ShowListFarmer extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_show:
                    ...
                    Intent i2= new Intent(ShowListFarmer.this,NewsActivity.class);
                    startActivity(i2);
                    return true;

                case R.id.navigation_test:

                    Intent i3= new Intent(ShowListFarmer.this,PlantDisease.class);
                    startActivity(i3);
                    return true;
                case R.id.nav_crop:

                    Intent i4= new Intent(ShowListFarmer.this,CropRecommendationActivity.class);
                    startActivity(i4);
                    return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_list_farm);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(ShowListFarmer.this));
